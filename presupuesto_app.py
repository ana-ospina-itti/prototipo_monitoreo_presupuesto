...
def create_sample_data():
    """
    Crea un dataframe de gastos de ejemplo para la demostración.
    Estos son los datos que la aplicación usará siempre.
    """
    gastos_data = {
        'monto compra': [
            # Mayo 2024
            ...
            180000, 90000, 550000, 120000, 400000, 110000, 150000,
            # Julio 2024
            100000, 80000, 480000, 150000, 300000, 120000, 95000
        ],
        'fecha': [
            # Mayo 2024
            '2024-05-03', '2024-05-08', '2024-05-10', '2024-05-15', '2024-05-18', '2024-05-22', '2024-05-25', '2024-05-28',
            ...
            '2024-06-02', '2024-06-05', '2024-06-11', '2024-06-16', '2024-06-20', '2024-06-24', '2024-06-28',
            # Julio 2024
            '2024-07-01', '2024-07-06', '2024-07-12', '2024-07-15', '2024-07-21', '2024-07-25', '2024-07-29'
        ],
        'categoría': [
            # Mayo 2024
            'Restaurante y Café', 'Transporte Apps', 'Mercado', 'Peluquería', 'Entretenimiento', 'Restaurante y Café', 'Transporte Apps', 'Mercado',
        ...
        'receptor de la compra': [
            ...
            'Lido Bar', 'Uber', 'Superseis', 'Barbería Don José', 'Teatro Municipal', 'El Bodegón', 'Casa Rica',
            # Julio 2024
            'Juan Valdez', 'Bolt', 'Superseis', 'Peluquería Estilo', 'Concierto', 'TGI Fridays', 'Stock'
        ]
    }
    return pd.DataFrame(gastos_data)
...
# AÑADIR IMAGEN LOCAL EN EL SIDEBAR
# Asegúrate de que el archivo 'logo_presupuesto.png' esté en la misma carpeta que este script
# y que lo hayas subido a tu repositorio de GitHub.
st.sidebar.image("logo_ueno.png", use_column_width=True)

st.sidebar.markdown("---")
st.sidebar.markdown("Esta aplicación es un prototipo para visualizar y comparar presupuestos mensuales.")


# --- Lógica Principal de la Aplicación ---
# La aplicación ahora siempre usa los datos de ejemplo.
df_gastos_base = create_sample_data()
df_gastos_base = process_gastos_data(df_gastos_base)
...
if not df_gastos_base.empty:
    ...
    if not meses_disponibles:
        st.warning("No se encontraron datos de ejemplo válidos.")
    else:
        selected_months = st.multiselect(
            "Selecciona hasta 2 meses para analizar y comparar:",
            options=meses_disponibles,
